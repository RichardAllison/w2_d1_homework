...
class TestLibrary < MiniTest::Test
  ...
  def test_change_rental_details
    @library.change_rental_details("jurassic_park", "Richard", "28/11/17")
    assert_equal({title: "jurassic_park", rental_details: {student_name: "Richard", date: "28/11/17"} }, @library.books[-1])
    # p @library.books[-1]
  end
